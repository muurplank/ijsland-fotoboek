...
export const KNOPPEN = [
  ...
  { key: 'inzet.achtergrond', groep: 'inzet', label: 'Achtergrond kaartje', type: 'kleur', standaard: '#fdfcf9', help: 'Ook de kleur van de waas buiten de uitsnede: die dempt het kaartje naar zijn eigen papier toe' },
  { key: 'inzet.zeeKleur', groep: 'inzet', label: 'Zeekleur', type: 'kleur', standaard: '#eef2f4', help: 'Een koele tint achter het eiland, zodat het als kaart leest en niet als vlek' },
  { key: 'inzet.landKleur', groep: 'inzet', label: 'Landkleur', type: 'kleur', standaard: '#e2ddd4'},
  { key: 'inzet.kustKleur', groep: 'inzet', label: 'Kustlijn', type: 'kleur', standaard: '#b9b0a3'},
  { key: 'inzet.kustMm', groep: 'inzet', label: 'Dikte kustlijn', type: 'mm', min: 0, max: 0.6, step: 0.02, standaard: 0.12, help: 'Wordt als randje langs de kust in het hoogtemodel geverfd. Nul laat hem weg' },
  { key: 'inzet.reisKleur', groep: 'inzet', label: 'Kleur hele reis', type: 'kleur', standaard: '#a8a099', help: 'De acht dagen samen, dun en licht onder de etappe van vandaag' },
  { key: 'inzet.routeKleur', groep: 'inzet', label: 'Etappe van vandaag', type: 'kleur', standaard: '#f4610c'},
  { key: 'inzet.lijnMm', groep: 'inzet', label: 'Dikte routelijn', type: 'mm', min: 0.1, max: 1.5, step: 0.05, standaard: 0.55, help: 'De etappe van vandaag; de hele reis wordt half zo dik getekend' },
  { key: 'inzet.stipMm', groep: 'inzet', label: 'Stip op begin en eind', type: 'mm', min: 0, max: 3, step: 0.1, standaard: 0.9, help: 'Waar je die ochtend vandaan kwam en waar je die avond sliep. Nul laat ze weg' },
  { key: 'inzet.kaderKleur', groep: 'inzet', label: 'Lijn om de uitsnede', type: 'kleur', standaard: '#f4610c'},
  { key: 'inzet.kaderMm', groep: 'inzet', label: 'Dikte van die lijn', type: 'mm', min: 0.05, max: 2, step: 0.05, standaard: 0.18, help: 'Dun houden: de sluier wijst de uitsnede al aan, dit lijntje zet alleen de rand scherp' },
  { key: 'inzet.sluierDekking', groep: 'inzet', label: 'Sluier buiten de uitsnede', type: 'getal', min: 0, max: 0.9, step: 0.01, standaard: 0.5, help: 'Alles buiten het kadertje krijgt een waas in de kleur van het kaartje, zodat je in een oogopslag ziet welk stuk op de grote kaart staat' },
  { key: 'inzet.afrondingMm', groep: 'inzet', label: 'Afronding hoeken', type: 'mm', min: 0, max: 12, step: 0.5, standaard: 2.5 },
  { key: 'inzet.padMm', groep: 'inzet', label: 'Ruimte rond het eiland', type: 'mm', min: 0, max: 12, step: 0.5, standaard: 3.5 },
  ...
  { key: 'voorblad.vlagBreedteMm', groep: 'voorblad', label: 'Breedte van de vlag', type: 'mm', min: 6, max: 140, step: 1, standaard: 38, help: 'Voor de zegel, de hoek en het beginpunt. Bij \'als het eiland\' volgt de maat uit het eiland zelf' },
  { key: 'voorblad.vlagPlek', groep: 'voorblad', label: 'Hoe de vlag meedoet', type: 'keuze', opties: ['als het eiland', 'postzegel', 'los in de hoek', 'bij het beginpunt'], standaard: 'als het eiland', help: 'als het eiland = de vlag vult de landsgrens, met de route er als lijn overheen · postzegel = gefrankeerd in een hoek, met kartelrand en afstempeling · los in de hoek = alleen de vlag, geparkeerd · bij het beginpunt = klein, op de plek waar de reis begon' },
  { key: 'voorblad.vlagHoek', groep: 'voorblad', label: 'In welke hoek', type: 'keuze', opties: ['rechtsboven', 'linksboven', 'rechtsonder', 'linksonder'], standaard: 'rechtsboven', help: 'Je kunt hem daarna alsnog naar elke plek slepen en aan het greepje groter maken; dit is waar hij begint' },
  { key: 'voorblad.vlagDraaiing', groep: 'voorblad', label: 'Scheef geplakt', type: 'graden', min: -20, max: 20, step: 0.5, standaard: -4, help: 'Een zegel die kaarsrecht staat is door een machine geplakt. Een paar graden scheef is door een hand geplakt, en dat is het hele verschil' },
  { key: 'voorblad.vlagTandMm', groep: 'voorblad', label: 'Kartelrand', type: 'mm', min: 0.6, max: 6, step: 0.1, standaard: 1.7, help: 'Hart-op-hart tussen de gaatjes van de perforatie. Alleen bij de postzegel' },
  { key: 'voorblad.vlagAfstempeling', groep: 'voorblad', label: 'Afstempeling', type: 'getal', min: 0, max: 1, step: 0.05, standaard: 0.55, help: 'De golfjes schuin over de zegel. Bleek, want een echte afstempeling is inkt over inkt en geen sticker erbovenop. Nul laat ze weg' },
