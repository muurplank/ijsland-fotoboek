...
export const KNOPPEN = [
  ...
  // ----------------------------------------------------------------- route
  { key: 'route.kleur', groep: 'route', label: 'Kleur binnenlijn', type: 'kleur', standaard: '#fc4c02'},
  { key: 'route.dikteMm', groep: 'route', label: 'Dikte binnenlijn', type: 'mm', min: 0.1, max: 6, step: 0.05, standaard: 1.55},
  { key: 'route.dekking', groep: 'route', label: 'Dekking binnenlijn', type: 'getal', min: 0, max: 1, step: 0.01, standaard: 0.47},
  { key: 'route.buitenKleur', groep: 'route', label: 'Kleur buitenlijn', type: 'kleur', standaard: '#fc4c02'},
  { key: 'route.buitenExtraMm', groep: 'route', label: 'Buitenlijn extra dik', type: 'mm', min: 0, max: 4, step: 0.05, standaard: 0.8, help: 'Hoeveel de buitenlijn aan elke kant buiten de binnenlijn uitsteekt' },
  ...
  // -------------------------------------------------------------- pijltjes
  { key: 'pijltjes.aan', groep: 'pijltjes', label: 'Richtingspijltjes', type: 'aanuit', standaard: false},
  ...
  { key: 'pijltjes.grootteMm', groep: 'pijltjes', label: 'Grootte', type: 'mm', min: 0.5, max: 12, step: 0.1, standaard: 1.7},
